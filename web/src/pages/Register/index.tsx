...
export const Register = () => {
  ...
  return (
    <div className='bg-body-light-200 flex flex-col justify-center items-center w-screen h-screen gap-10'>
      ...
      <Input type="text" placeholder='Digite seu Nome' onBlur={(e) => setName(e.target.value)} value={'David'} />
      <Input type="date" placeholder='Digite sua data de nascimento' onBlur={(e) => setBirthdate(e.target.value)} value={'1997-10-10'} />
      <Input type="text" placeholder='Digite seu CPF' onBlur={(e) => setCpf(e.target.value)} value={'01234567890'} />
      <Input type="email" placeholder='Digite seu Email' onBlur={(e) => setEmail(e.target.value)} value={'david@gmail.com'} />
      <Input type="password" placeholder='Digite sua senha' onBlur={(e) => setPassword(e.target.value)} value={'abcdef'} />
